...
if __name__ == '__main__':
    ...
    parser.add_argument('-diffusion_model_path', type=str, help='Path to saved model weights', default='X:\\dlas\\experiments\\train_diffusion_tts_medium\\models\\22500_generator_ema.pth')
    ...
    cond = load_audio(args.cond, 22050).to(args.device)
